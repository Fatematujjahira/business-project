...
import agent2 from "../../img/team/team-1.jpg";
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card-box-d">
                <div class="card-img-d">
                  <img src={agent2} alt="" class="img-d img-fluid" />
                </div>
            ...
            <div class="col-md-4">
              <div class="card-box-d">
                <div class="card-img-d">
                  <img src={agent1} alt="" class="img-d img-fluid" />
                </div>
                <div class="card-overlay card-overlay-hover">
                  <div class="card-header-d">
                    <div class="card-title-d align-self-center">
            ...
            <div class="col-md-4">
              <div class="card-box-d">
                <div class="card-img-d">
                  <img src={agent5} alt="" class="img-d img-fluid" />
                </div>
                <div class="card-overlay card-overlay-hover">
                  <div class="card-header-d">
                    <div class="card-title-d align-self-center">
